 ...
 */
#[Fillable([
    'student_id', 'skill_id', 'subject_id', 'grade_id',
    'trimester_id', 'year_id', 'value', 'recorded_by',
])]
class IntegralClassroomSupport extends Model
{
    ...
    {
        return $this->belongsTo(IntegralClassroomSupportIndicator::class, 'skill_id');
    }
