...
new #[Title('Crear Esquema de Calificacion')] class extends Component {
    public ?int $year_id = null;
    public float $formative_percentage = 70.00;
    public float $summative_percentage = 30.00;
    public float $exam_percentage = 20.00;
    public float $project_percentage = 10.00;
    ...
    {
        return [
            'year_id' => ['required', 'exists:scolar_years,id', 'unique:grading_schemes,year_id'],
    ...
    public function save(): void
    {
        ...
        Flux::toast(variant: 'success', text: __('Esquema de calificacion creado correctamente.'));
...
<div>
    <div class="flex items-center justify-between mb-6">
        <div>
            <flux:heading size="xl">{{ __('Crear Esquema de Calificacion') }}</flux:heading>
            <flux:text variant="subtle" class="mt-1">{{ __('Registrar un nuevo esquema de calificacion') }}</flux:text>
        </div>
    ...
    <form wire:submit="save" class="space-y-6 max-w-3xl">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <flux:field>
                        ...
                        <flux:input type="number" wire:model="formative_percentage" step="0.01" min="0" max="100" placeholder="70.00" />
                    ...
                    <flux:field>
                        ...
                        <flux:input type="number" wire:model="summative_percentage" step="0.01" min="0" max="100" placeholder="30.00" />
                    ...
                    <flux:field>
                        ...
                        <flux:input type="number" wire:model="exam_percentage" step="0.01" min="0" max="100" placeholder="20.00" />
                    ...
                    <flux:field>
                        ...
                        <flux:input type="number" wire:model="project_percentage" step="0.01" min="0" max="100" placeholder="10.00" />
        ...
        <div class="flex gap-3">
            <flux:button type="submit" variant="primary" wire:loading.attr="disabled">{{ __('Guardar Esquema') }}</flux:button>
